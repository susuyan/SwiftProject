...
extension UIScrollView {
    var yHeader: MJRefreshHeader {
        get { return mj_header }
        set { mj_header = newValue }
    }
    
    var yFooter: MJRefreshFooter {
        get { return mj_footer }
        set { mj_footer = newValue }
    }
}

class YRefreshHeader: MJRefreshGifHeader {
...
class YRefreshAutoHeader: MJRefreshHeader {}

class YRefreshFooter: MJRefreshBackNormalFooter {}

class YRefreshAutoFooter: MJRefreshAutoFooter {}


class YRefreshDiscoverFooter: MJRefreshBackGifFooter {
